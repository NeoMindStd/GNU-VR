...
public class GunController : MonoBehaviour 
{
    ...
    {
        currentGun.carryBulletCount = Mathf.Min(currentGun.carryBulletCount + ammo, currentGun.maxBulletCount);
    }
    ...
    {
        if (Input.GetButton("Fire1") && currentFireRate <= 0 && !isReload && !theCrosshair.isRunning())
        {
            Fire();
        }
    }
    ...
    {
        if (Input.GetButtonDown("Fire2") && !isReload && !theCrosshair.isRunning()) FineSight();
    }
